...
START_TEST(is_not_equal_1) {
  ...
  int ret = s21_is_not_equal(d1, d2);
...
Suite *s21_test_is_not_equal() {
  ...
  tcase_add_test(case_1, is_not_equal_1);
  tcase_add_test(case_1, is_not_equal_2);
  tcase_add_test(case_1, is_not_equal_3);
  tcase_add_test(case_1, is_not_equal_4);
  tcase_add_test(case_1, is_not_equal_5);
  tcase_add_test(case_1, is_not_equal_6);
  tcase_add_test(case_1, is_not_equal_7);

  TCase *case_2 = tcase_create(C_RED "with_NaN" C_DEFAULT);
  tcase_add_test(case_2, is_not_equal_8);
  tcase_add_test(case_2, is_not_equal_9);

  Suite *suite = suite_create(C_CYAN "s21_is_not_equal" C_DEFAULT);
